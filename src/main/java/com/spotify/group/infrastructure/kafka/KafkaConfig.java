...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(KafkaProperties properties, ObjectMapper objectMapper) {
        ...
        consumerProps.put(JsonDeserializer.TRUSTED_PACKAGES, TRUSTED_PACKAGE);
        return new DefaultKafkaConsumerFactory<>(consumerProps, new StringDeserializer(), new JsonDeserializer<>(objectMapper));
    }
}